...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<rspec-core>.freeze, ["~> 3.1.0"])
      s.add_runtime_dependency(%q<rspec-expectations>.freeze, ["~> 3.1.0"])
      s.add_runtime_dependency(%q<rspec-mocks>.freeze, ["~> 3.1.0"])
    else
      s.add_dependency(%q<rspec-core>.freeze, ["~> 3.1.0"])
      s.add_dependency(%q<rspec-expectations>.freeze, ["~> 3.1.0"])
      s.add_dependency(%q<rspec-mocks>.freeze, ["~> 3.1.0"])
    end
  else
    s.add_dependency(%q<rspec-core>.freeze, ["~> 3.1.0"])
    s.add_dependency(%q<rspec-expectations>.freeze, ["~> 3.1.0"])
